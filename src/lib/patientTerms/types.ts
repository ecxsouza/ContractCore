...
export const EMPTY_PATIENT_TERM_FORM: PatientTermFormData = {
  ...
  regras: {
    regra_falta:               'O horário agendado é reservado exclusivamente para o paciente. Em caso de não comparecimento sem aviso prévio dentro do prazo mínimo combinado, a sessão poderá ser cobrada integralmente, pois o horário ficou indisponível para outros atendimentos e para a agenda do profissional.\n\nSituações excepcionais, como emergências, imprevistos graves ou motivos de força maior, poderão ser avaliadas pela clínica de forma individual, buscando equilíbrio entre a responsabilidade do paciente e a justa remuneração do profissional.',
    regra_cancelamento:        'O cancelamento deverá ser comunicado pelos canais administrativos da clínica, preferencialmente WhatsApp ou e-mail, respeitando a antecedência mínima combinada.\n\nCancelamentos realizados dentro do prazo mínimo permitem a reorganização da agenda e, sempre que possível, a oferta do horário a outro paciente. Cancelamentos fora do prazo poderão ser considerados como sessão devida, salvo situações excepcionais avaliadas pela clínica.\n\nCaso o cancelamento seja realizado pela clínica ou pelo profissional, o paciente não terá qualquer cobrança pelo horário cancelado, e a remarcação será oferecida conforme disponibilidade de agenda.',
    antecedencia_cancelamento: '48 horas úteis de antecedência.\n\nQuando o atendimento ocorrer às segundas-feiras ou após feriados, recomenda-se que o cancelamento seja comunicado no último dia útil anterior, dentro do horário administrativo da clínica.',
    regra_remarcacao:          'A remarcação poderá ser solicitada pelo paciente e será realizada conforme disponibilidade da agenda da clínica e do profissional.\n\nA solicitação de remarcação dentro do prazo mínimo não gera cobrança adicional. Quando solicitada fora do prazo, a sessão poderá ser mantida como devida, especialmente quando não houver possibilidade de reaproveitamento do horário.\n\nA clínica e o profissional se comprometem a buscar alternativas razoáveis de agenda, sem garantia de manutenção do mesmo dia, horário ou profissional, salvo quando previamente acordado.',
    regra_atraso:              'Em caso de atraso do paciente, a sessão poderá ocorrer pelo tempo restante do horário originalmente reservado, sem extensão automática do tempo de atendimento, para não prejudicar os atendimentos seguintes.\n\nQuando o atraso inviabilizar a realização adequada da sessão, a clínica poderá considerá-la como realizada ou não comparecida, conforme o caso e a política administrativa vigente.\n\nSe o atraso ocorrer por responsabilidade da clínica ou do profissional, o tempo deverá ser compensado, remarcado ou ajustado de comum acordo, sem prejuízo financeiro ao paciente.',
    regra_reajuste:            'Os valores poderão ser reajustados periodicamente, mediante comunicação prévia ao paciente ou responsável financeiro, respeitando a periodicidade mínima estabelecida e a política administrativa da clínica.\n\nO reajuste tem como finalidade manter a sustentabilidade do serviço, considerando custos operacionais, atualização profissional, estrutura da clínica e continuidade do atendimento.\n\nO paciente ou responsável será informado antes da aplicação do novo valor, podendo manifestar dúvidas ou solicitar esclarecimentos pelos canais administrativos da clínica.',
    periodicidade_reajuste:    'Anual, com intervalo mínimo de 12 meses, salvo situações específicas previamente justificadas e comunicadas.',
    aviso_previo_reajuste:     '30 dias de antecedência.',
    regra_encerramento:        'O atendimento poderá ser encerrado por iniciativa do paciente, responsável legal, responsável financeiro, clínica ou profissional, mediante comunicação prévia pelos canais administrativos da clínica.\n\nSempre que possível, recomenda-se aviso prévio de 30 dias, especialmente em atendimentos contínuos, para permitir organização da agenda, fechamento administrativo adequado e eventual orientação sobre continuidade do cuidado em outro serviço ou profissional, quando aplicável.\n\nO encerramento não elimina valores pendentes referentes a sessões já realizadas, horários reservados sem cancelamento no prazo ou demais obrigações administrativas previamente acordadas.',
  },
